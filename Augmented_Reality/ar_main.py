...
from Functions.Visualize import draw_axis
from Functions.objloader import *  # Load obj and corresponding material and textures.
from Functions.MatrixTransform import extrinsic2ModelView, intrinsic2Project
...
class AR_render:
    ...
    def initOpengl(self, width, height, pos_x=500, pos_y=500, window_name=b'AR_Demo'):
...
if __name__ == "__main__":
    ...
    dist_coeff = np.array([6.58942427e-02, -4.68706097e-01, 1.23231238e-03, -6.95244221e-04, 1.06684585e+00])
    instance = AR_render(cam_matrix, dist_coeff, './Models/Box/box.obj', model_scale=0.03)
    instance.run()
